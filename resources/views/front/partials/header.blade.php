                        ...
                        <div class="col-sm-12">
                            ...
                            <nav class="rs-menu">
                                <ul class="nav-menu text-center">
                                    ...
                                    <li @if(Request::is('/')) class="active" @endif><a href="{{ route('homePage') }}">Home</a>
                                    </li>
                                    <li @if(Request::is('about-us')) class="active" @endif><a
                                            href="{{ route('about-us') }}">About Us</a></li>
                                    <li @if(Request::is('notice-board')) class="active" @endif><a
                                            href="{{ route('notice-board') }}">Notice Board</a></li>
                                    ...
                                    <li @if(Request::is('admission')) class="active" @endif><a
                                            href="{{ route('admission') }}">Admission</a></li>
                                    <li @if(Request::is('institute')) class="active" @endif><a
                                            href="{{ route('institute') }}">Institute</a></li>
                                    <li @if(Request::is('alumni')) class="active" @endif><a
                                            href="{{ route('alumni') }}">Alumni</a></li>
                                    <li @if(Request::is('cell')) class="active" @endif><a href="{{ route('cell') }}">Cell</a>
                                    </li>

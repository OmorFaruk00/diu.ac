...
<div id="rs-slider" class="slider-overlay-2">
    <div id="home-slider">
        ...
        <div class="item {{ $key == 0 ? 'active' : '' }}">
            <img class="image-fluid" src="{{ $slider->image_url }}" alt="{{ $slider->title }}" />
                ...
                <div class="display-table">
                    <div class="display-table-cell">
                        <div class="container text-center" style="margin-top: 230px">
                            ...
                            @if($slider->apply_url)
                            <a href="{{ $slider->apply_url }}" target="_blank" class="sl-get-started-btn"
                                data-animation-in="lightSpeedIn" data-animation-out="animate-out">APPLY NOW</a>
                            @endif
                ...
                <div id="accordion" class="rs-accordion-style1">
                    <div class="card">
                        <div class="card-header" id="ourMission">
                            <h3 class="acdn-title collapsed" data-toggle="collapse" data-target="#collapseOurMission"
                    ...
                    <div class="card">
                        <div class="card-header" id="ourVision">
                            <h3 class="acdn-title collapsed" data-toggle="collapse" data-target="#collapseOurVission"
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="itsFounder" data-parent="#accordion">
                            <div class="card-body">
                ...
                <div id="campusAccordion" class="rs-accordion-style1">
                    <div class="card">
                        <div class="card-header" id="PermanentCampus">
                            <h3 class="acdn-title collapsed" data-toggle="collapse"
                                data-target="#collapsePermanentCampus" aria-expanded="true"
                                aria-controls="collapsePermanentCampus">
                                Permanent Campus
                            </h3>
                        </div>
                    ...
                    {{-- <div class="card">
                        <div class="card-header" id="BananiCampus">
                            <h3 class="acdn-title collapsed" data-toggle="collapse" data-target="#collapseBananiCampus"
                    ...
                    {{-- <div class="card">
                        <div class="card-header mb-0" id="GreenRoadCampus">
                            <h3 class="acdn-title collapsed" data-toggle="collapse"
                                data-target="#collapseGreenRoadCampus" aria-expanded="false"
...
<div class="rs-counter pt-45 pb-70 back-image universitiy-achievement mt-3"
    ...
    <div class="container">
        <div class="sec-title white-text mb-30 text-center">
            <h2>Current Statistics: Our Strength</h2>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="rs-counter-list">
                    ...
                    <h4 class="counter-desc">Number of alumni</h4>
                </div>
            </div>
        </div>
    </div>

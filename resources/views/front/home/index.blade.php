            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="rs-counter-list">
                        <div class="count-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-white" style="width: 60px" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="rs-counter-list">
                        ...
                        <div class="count-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-white" style="width: 60px" fill="none" viewBox="0 0 24 24" stroke="currentColor">

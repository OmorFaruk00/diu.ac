<template>
    ...
    <div class="rs-carousel owl-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true"
        ...
        <div class="product-item" v-for="(row ,index) in 10" :key="index">
            <div class="product-img">
                <a href="javaScript:void(0)">
                    <img src="http://webdev.diu.ac/front/images/programs/2.jpg" alt="sss"/>
                </a>
            </div>
            <h4 class="product-title"><a href="javaScript:void(0)">Business Administration {{ row }}</a></h4>
